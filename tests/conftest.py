...
# WARNING: Ensure imports from `fastbackend` comes after this line
from fastbackend import app, settings, db  # noqa
from fastbackend.cli import create_user, cli  # noqa
